...
### Integrating `@kitconcept/volto-plate`/`kitconcept.plate` in a project
...
Update the `pyproject.toml` and `package.json` on your project to use the latest public release `volto-plate`
